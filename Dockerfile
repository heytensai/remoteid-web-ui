...
COPY app.py config.py database.py session_detect.py session_scheduler.py maintenance_scheduler.py wsgi.py gunicorn.conf.py alert_engine.py import_db.py push_service.py ./
